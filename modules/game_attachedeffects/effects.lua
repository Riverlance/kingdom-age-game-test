...
AttachedEffectManager.register(7, 'Pentagram Aura', '/images/game/effect/pentagram', ThingExternalTexture, {
    size = {128, 128},
    offset = {50, 45}
})

AttachedEffectManager.register(8, 'Ki', '/images/game/effect/ki', ThingExternalTexture, {
    size = {140, 110},
    offset = {60, 75, true}
})

AttachedEffectManager.register(9, 'Thunder', '/images/game/effect/thunder', ThingExternalTexture, {
    loop = 1,
    offset = {215, 230}
})
