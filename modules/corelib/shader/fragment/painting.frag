...
#define InputSize vec2(800.0, 600.0) // Width and height in pixels of game screen
#define OutputSize InputSize // Width and height in pixels of game screen
...
void main()
{
    ...
    vec2 pos = fract(v_TexCoord * SourceSize.xy) - vec2(0.5, 0.5);
    vec2 coord = v_TexCoord - pos * SourceSize.zw;
